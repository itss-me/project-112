...
classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/CITqdkrTy/model.json',modelLoaded);
...
function speak(){
    ...
    speak_data_2 = "And the second predicition is"+prediction2;
